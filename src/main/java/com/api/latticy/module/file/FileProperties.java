package com.api.latticy.module.file;

import com.api.latticy.common.factory.YamlPropertySourceFactory;
...
@PropertySource(
        value = "classpath:com/api/latticy/extension/file/config.yml",
